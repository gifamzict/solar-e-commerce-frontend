                ...
                <div className="md:col-span-9 space-y-8">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <Button onClick={() => isEditing ? handleCancel() : setIsEditing(true)} variant={isEditing ? "outline" : "default"}>
                                    ...
                                    {recentOrders.map((order) => (
                                        <div key={order.id} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                            ...
                                            <div className="text-right">
                                                <p className="font-bold">{ensureNairaSymbol(order.formatted_total)}</p>
